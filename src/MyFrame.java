...
public class MyFrame extends JFrame{
	...
	JButton personSearch=new JButton("Търсене по години");
	...
	public MyFrame() {
	 ...
	 midPanel.add(editBt);
	 midPanel.add(personSearch);
	 midPanel.add(personRefresh);
	 midPanel.add(personCombo);
	 
	 this.add(midPanel);
	 
	 addBt.addActionListener(new AddActionBt());
	...
	class AddActionBt implements ActionListener{
